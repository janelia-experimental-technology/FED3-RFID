/*
  RFID capabilities have been integrated into this program
...
void FED3::writeHeader() {
  ...
  if (tempSensor == false){
    logfile.println("MM:DD:YYYY hh:mm:ss,Library_Version,Session_type,Device_Number,Battery_Voltage,Motor_Turns,FR,Event,Active_Poke,Left_Poke_Count,Right_Poke_Count,Pellet_Count,Block_Pellet_Count,Retrieval_Time,InterPelletInterval,Poke_Time,RFID_Tag, RFID_Temp,RFID_Time_Stamp MM:DD:YYYY hh:mm:ss");
  }


  if (tempSensor == true){
    logfile.println("MM:DD:YYYY hh:mm:ss,Temp,Humidity,Library_Version,Session_type,Device_Number,Battery_Voltage,Motor_Turns,FR,Event,Active_Poke,Left_Poke_Count,Right_Poke_Count,Pellet_Count,Block_Pellet_Count,Retrieval_Time,InterPelletInterval,Poke_Time,RFID_Tag,RFID_Temp,RFID_Time_Stamp MM:DD:YYYY hh:mm:ss");
  }
...
//Write RFID data to SD card
void FED3::logRFIDData() {
  if (EnableSleep==true){
    digitalWrite (MOTOR_ENABLE, LOW);  //Disable motor driver and neopixel
  }
  SD.begin(cardSelect, SD_SCK_MHZ(4));
  ...
  /////////////////////////////////
    ...
    logfile.print(rfidTag); // print tag ID
    logfile.print(",");
  ...
  /////////////////////////////////
    ...
    logfile.print(rfidTemp); // print temperature
    logfile.print(",");
